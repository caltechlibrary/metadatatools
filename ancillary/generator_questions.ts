...
for (let k of Object.keys(identifier_types)) {
  console.log(
    `## ${i}. How do I write a normalize, validator and verifier functions for ${
      identifier_types[k]
    } in Deno and TypeScript using the Deno standard library? What is the copyright and attribution required for generated code?`,
  );
  console.log("");
  i++;
}
