(() => {
  ...
  var et;
  function ie(n, e) {
    return et || (et = document.createElement("a")), et.href = e, n === et.href;
  }
  function En(n) {
          ...
          : this._observer = new ResizeObserver((t) => {
            ...
            for (let r of t) {
              de.entries.set(r.target, r),
                (s = this._listeners.get(r.target)) === null || s === void 0 ||
                s(r);
            }
          });
      }
  ...
  var se = [];
  var le = [], re = [], ft = [], Fs = Promise.resolve(), dt = !1;
  function Ns() {
    dt || (dt = !0, Fs.then(kn));
  }
  function ht(n) {
  ...
  function yn(n, e, t, s, r, l, i, a, o, f, u, m) {
    let p = n.length, h = l.length, _ = p, c = {};
    for (; _--;) c[n[_].key] = _;
    let d = [], T = new Map(), R = new Map(), M = [];
    for (_ = h; _--;) {
      let v = m(r, l, _), H = t(v), O = i.get(H);
      O ? s && M.push(() => O.p(v, e)) : (O = f(H, v), O.c()),
        T.set(H, d[_] = O),
        H in c && R.set(H, Math.abs(_ - c[H]));
    }
    let D = new Set(), X = new Set();
    function V(v) {
      U(v, 1), v.m(a, u), i.set(v.key, v), u = v.first, h--;
    }
    for (; p && h;) {
      let v = d[h - 1], H = n[p - 1], O = v.key, W = H.key;
      v === H
        ? (u = v.first, p--, h--)
        : T.has(W)
        ? !i.has(O) || D.has(O)
    ...
    if (
      f.ctx = t
        ? t(n, e.props || {}, (m, p, ...h) => {
          ...
          return f.ctx && r(f.ctx[m], f.ctx[m] = _) &&
  ...
  function lt(n, e = {}) {
    let t = vn(), s = String(n), r = s.toLowerCase(), l = 0;
    ...
    if (l > 1 && l < 9) {
      if (t.language = s.slice(0, l), l < 4) {
        ...
        for (
          ;
          r.charCodeAt(l) === 45 && I(r.charCodeAt(l + 1)) &&
          I(r.charCodeAt(l + 2)) && I(r.charCodeAt(l + 3)) &&
          !I(r.charCodeAt(l + 4));
        ) {
          if (a > 2) {
            return i(
      ...
      for (
        r.charCodeAt(l) === 45 && I(r.charCodeAt(l + 1)) &&
        I(r.charCodeAt(l + 2)) && I(r.charCodeAt(l + 3)) &&
        I(r.charCodeAt(l + 4)) && !I(r.charCodeAt(l + 5)) &&
        (t.script = s.slice(l + 1, l + 5), l += 5),
          r.charCodeAt(l) === 45 &&
          (I(r.charCodeAt(l + 1)) && I(r.charCodeAt(l + 2)) &&
              !I(r.charCodeAt(l + 3))
            ? (t.region = s.slice(l + 1, l + 3), l += 3)
            : $(r.charCodeAt(l + 1)) && $(r.charCodeAt(l + 2)) &&
              $(r.charCodeAt(l + 3)) && !$(r.charCodeAt(l + 4)) &&
      ...
      for (
        ;
        r.charCodeAt(l) === 45 &&
        !(r.charCodeAt(l + 1) === 120 || !Z(r.charCodeAt(l + 1)) ||
          r.charCodeAt(l + 2) !== 45 || !Z(r.charCodeAt(l + 3)));
      ) {
        let a = l + 2, o = 0;
        for (
          ;
          r.charCodeAt(a) === 45 && Z(r.charCodeAt(a + 1)) &&
          Z(r.charCodeAt(a + 2));
        ) {
          let f = a + 1;
  ...
  function Fn(n) {
    ...
    return {
      ...
      p(s, r) {
        s[1].meta.image
          ? t ? t.p(s, r) : (t = Nn(s), t.c(), t.m(e, null))
          : t && (t.d(1), t = null);
      },
      d(s) {
        s && k(e), t && t.d();
    ...
    return {
      ...
      p(r, l) {
        l & 2 && !ie(e.src, t = r[1].meta?.image) && g(e, "src", t),
          l & 2 && s !== (s = r[1].meta?.image_alt || r[1].meta?.title) &&
          g(e, "alt", s);
      },
      d(r) {
        r && k(e);
  ...
  function jn(n) {
    let e, t = n[8].replace(/^(\w)/, zn) + "", s, r, l = n[9] + "", i, a, o;
    return {
      c() {
        e = C("li"),
          s = w(t),
  ...
  function Ws(n) {
    ...
    return {
      ...
      p(d, T) {
        if (
          d[0]
            ? m ? m.p(d, T) : (m = Ln(d), m.c(), m.m(e.parentNode, e))
            : m && (m.d(1), m = null),
            T & 2 && l !== (l = d[1].meta?.title + "") && N(i, l),
            T & 2 && a !== (a = d[1].meta?.url || d[1].url) && g(r, "href", a),
            d[4]
              ? p ? p.p(d, T) : (p = Bn(d), p.c(), p.m(t, f))
              : p && (p.d(1), p = null),
            T & 8
        ) {
          h = d[3];
        ...
        d[2].length
          ? c ? c.p(d, T) : (c = Wn(d), c.c(), c.m(t, null))
          : c && (c.d(1), c = null);
      },
      d(d) {
  ...
  function Ln(n) {
    ...
    return {
      ...
      p(s, r) {
        s[1].meta.image
          ? t ? t.p(s, r) : (t = qn(s), t.c(), t.m(e, null))
          : t && (t.d(1), t = null);
      },
      d(s) {
        s && k(e), t && t.d();
  ...
  function Bn(n) {
    ...
    return {
      c() {
        e = C("p"), g(e, "class", "pagefind-ui__result-excerpt svelte-4xnkmf");
      },
      m(s, r) {
  ...
  function Gn(n) {
    let e, t = n[11].replace(/^(\w)/, Kn) + "", s, r, l = n[12] + "", i, a, o;
    return {
      c() {
        e = C("li"),
          s = w(t),
  ...
  function Gs(n) {
    ...
    return {
      c() {
        e = C("li"), r.c(), g(e, "class", "pagefind-ui__result svelte-4xnkmf");
      },
      m(l, i) {
        S(l, e, i), r.m(e, null);
      },
  ...
  function Ks(n, e, t) {
    let { show_images: s = !0 } = e,
      ...
      m = (_, c) => {
        ...
        let d = [..._].sort((T, R) => R.locations.length - T.locations.length)
          .slice(0, 3).map((T) => T.url);
  ...
  function Xn(n) {
    ...
    return {
      ...
      p(o, f) {
        if (
          f & 112 && s !== (s = o[4]("filters_label", o[5], o[6]) + "") &&
          N(r, s), f & 143
        ) {
    ...
    return {
      ...
      p(M, D) {
        n = M,
          ...
          D & 2 && l !== (l = n[14]) && (t.__value = l, t.value = t.__value),
  ...
  function xn(n) {
    let e, t = (n[2] || n[15] || n[0][`${n[10]}:${n[14]}`]) && Qn(n);
    return {
      c() {
        t && t.c(), e = x();
      },
      ...
      p(s, r) {
        s[2] || s[15] || s[0][`${s[10]}:${s[14]}`]
          ? t ? t.p(s, r) : (t = Qn(s), t.c(), t.m(e.parentNode, e))
          : t && (t.d(1), t = null);
      },
      d(s) {
        t && t.d(s), s && k(e);
  ...
  function Js(n) {
    let e = n[1] && Object.entries(n[1]).length, t, s = e && Xn(n);
    return {
      c() {
        s && s.c(), t = x();
      },
      ...
      p(r, [l]) {
        l & 2 && (e = r[1] && Object.entries(r[1]).length),
          e
            ? s ? s.p(r, l) : (s = Xn(r), s.c(), s.m(t.parentNode, t))
            : s && (s.d(1), s = null);
      },
      i: z,
      o: z,
  ...
  var es = (n) => n.toLocaleUpperCase(), ts = (n) => n.toLowerCase();
  function Ys(n, e, t) {
      ...
      n.$$.update = () => {
        if (n.$$.dirty & 258) {
          e: if (s && !u) {
            ...
            h.length === 1 && Object.entries(h[0][1])?.length <= 6 &&
              t(7, m = !0);
          }
        }
      },
  ...
  function is(n) {
    ...
    return n[0] !== void 0 && (l.selected_filters = n[0]),
      e = new ns({ props: l }),
  ...
  function as(n) {
    let e, t, s, r, l = [Ma, ya], i = [];
    function a(o, f) {
      return o[14] ? 0 : 1;
    }
    return t = a(n, [-1, -1]), s = i[t] = l[t](n), {
      c() {
        e = C("div"),
          s.c(),
      ...
      p(c, d) {
        u === (u = f(c, d)) && m
          ...
          c[13].results.length > c[17]
            ? _ ? _.p(c, d) : (_ = us(c), _.c(), _.m(a.parentNode, a))
            : _ && (_.d(1), _ = null);
      },
      i(c) {
        if (!o) {
  ...
  function Ma(n) {
    ...
    return {
      ...
      p(s, r) {
        s[16]
          ? t ? t.p(s, r) : (t = cs(s), t.c(), t.m(e.parentNode, e))
          : t && (t.d(1), t = null);
      },
      i: z,
      o: z,
  ...
  function Aa(n) {
    let e = n[20]("many_results", n[19], n[7]).replace(/\[SEARCH_TERM\]/, n[16])
        .replace(
          /\[COUNT\]/,
    ...
    return {
      ...
      p(s, r) {
        r[0] & 598144 &&
          e !==
            (e = s[20]("many_results", s[19], s[7]).replace(
              /\[SEARCH_TERM\]/,
              s[16],
            ).replace(
              /\[COUNT\]/,
  ...
  function va(n) {
    let e = n[20]("one_result", n[19], n[7]).replace(/\[SEARCH_TERM\]/, n[16])
        .replace(
          /\[COUNT\]/,
    ...
    return {
      ...
      p(s, r) {
        r[0] & 589952 &&
          e !==
            (e =
              s[20]("one_result", s[19], s[7]).replace(/\[SEARCH_TERM\]/, s[16])
                .replace(
                  /\[COUNT\]/,
  ...
  function wa(n) {
    ...
    return {
      ...
      p(s, r) {
        r[0] & 589952 &&
          e !==
            (e = s[20]("zero_results", s[19], s[7]).replace(
              /\[SEARCH_TERM\]/,
              s[16],
            ) + "") &&
          N(t, e);
  ...
  function os(n, e) {
    let t, s, r, l, i, a = [Fa, Ha], o = [];
    function f(u, m) {
      return u[3] ? 0 : 1;
    }
    return s = f(e, [-1, -1]), r = o[s] = a[s](e), {
      key: n,
      first: null,
      c() {
  ...
  function us(n) {
    let e, t = n[20]("load_more", n[19], n[7]) + "", s, r, l;
    return {
      c() {
        e = C("button"),
          s = w(t),
      ...
      p(i, a) {
        a[0] & 524416 && t !== (t = i[20]("load_more", i[19], i[7]) + "") &&
          N(s, t);
      },
      d(i) {
        i && k(e), r = !1, l();
  ...
  function cs(n) {
    ...
    return {
      ...
      p(r, l) {
        l[0] & 589952 &&
          t !==
            (t = r[20]("searching", r[19], r[7]).replace(
              /\[SEARCH_TERM\]/,
              r[16],
            ) + "") &&
          N(s, t);
    ...
    return {
      ...
      p(R, M) {
        ...
        g(s, "placeholder", r),
          ...
          (!h || M[0] & 524416) &&
          a !== (a = R[20]("clear_search", R[19], R[7]) + "") && N(o, a),
          ...
          (!h ||
            M[0] & 524416 && p !== (p = R[20]("search_label", R[19], R[7]))) &&
          g(t, "aria-label", p),
  ...
  function ja(n, e, t) {
    let s = {}, r = rs.map((E) => E.match(/([^\/]+)\.json$/)[1]);
    ...
    gt(() => {
      ...
      t(
        19,
        hn = s[`${F.language}-${F.script}-${F.region}`] ||
          s[`${F.language}-${F.region}`] || s[`${F.language}`] || s.en,
      );
    }),
      Et(() => {
        H?.destroy?.(), H = null;
...
`),
      ...
      ms = (E) => {
        let F = {};
        return Object.entries(E).filter(([, j]) => j).forEach(([j]) => {
          let [L, te] = j.split(/:(.*)$/);
          F[L] = F[L] || [], F[L].push(te);
        }),
          F;
      ...
      gs = async (E, F) => {
        t(16, fn = E || ""),
          ...
          t(15, ut = !0),
          await pn();
        let j = ++_n, L = { filters: F };
        X && typeof X == "object" && (L.sort = X);
        let te = await H.search(E, L);
        _n === j &&
          (te.filters && Object.keys(te.filters)?.length &&
            t(18, ce = te.filters),
            t(13, cn = te),
            t(14, ot = !1),
            t(17, ct = i));
