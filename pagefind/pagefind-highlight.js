        ...
        createClass(DOMIterator2, [{
            ...
            ifr.forEach(function (ifrDict) {
              if (!ifrDict.handled) {
                _this4.getIframeContents(ifrDict.val, function (con) {
                  _this4.createInstanceOnIframe(con).forEachNode(
                    whatToShow,
                    eCb,
                    fCb,
                  );
          ...
          value: function matches(element, selector) {
            var selectors = typeof selector === "string"
                ? [selector]
                : selector,
              fn = element.matches || element.matchesSelector ||
      ...
      var Mark$1 = function () {
        ...
        createClass(Mark3, [{
              ...
              if (syn.hasOwnProperty(index)) {
                ...
                if (k1 !== "" && k2 !== "") {
                  str = str.replace(
                    ...
                    joinerPlaceholder + ("(" + this.processSynomyms(k1) + "|") +
                      (this.processSynomyms(k2) + ")") + joinerPlaceholder,
                  );
                }
              }
            }
          ...
          value: function createWildcardsRegExp(str) {
            ...
            return str.replace(/\u0001/g, spaces ? "[\\S\\s]?" : "\\S?")
          ...
          value: function callNoMatchOnInvalidRanges(range, last) {
            ...
            if (range && typeof range.start !== "undefined") {
              ...
              if (
                this.isNumeric(range.start) && this.isNumeric(range.length) &&
...
var PagefindHighlight = class {
  ...
  addHighlightStyles(className) {
    ...
    styleElement.innerText =
      `:where(.${className}) { background-color: yellow; color: black; }`;
